...
public:
	...
	class StackedChannel {
		TS &value_;

		StackedChannel(TS &value) : value_(value) {};
	...
	// Single channels of the stacked Color type can be accessed through Interface class
	StackedChannel<T, RedType, DG + DB> red() { return {value_}; }
	StackedChannel<T, GreenType, DB> green() { return {value_}; }
	StackedChannel<T, BlueType, 0> blue() { return {value_}; }
