...
class Vector : public std::array<T, N>
{
	...
	constexpr void push(U v, Args... args)
	{
	...
	constexpr void push(const std::array<U, M> &arr, Args... args)
	{
...
using Vector3li = Vector<int32_t, 3>;
using Vector3lu = Vector<uint32_t, 3>;
